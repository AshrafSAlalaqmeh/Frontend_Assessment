...
import zainSilverLogo from "../assets/zainSilverLogo.png";

const header = () => {
  return (
    <div className="header-container w-100">
      <div className="d-flex justify-content-between px-2 align-items-center">
        <img src={zainSilverLogo} alt="zain logo" className="w-25 p-5" />
        <div
      ...
      <div className="d-flex w-100  nav-height px-4 justify-content-between align-items-center">
        <div className="d-flex gap-5 px-5">
          ...
          <div>
            <h5 className="text">Recharge Line</h5>
          </div>
        </div>
